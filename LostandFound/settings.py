...
SECRET_KEY = 'django-insecure-qmn1zhxuc#^#nbv(fcp+=0#jxuqhuti6pe9=l^msr=*@6e8nj^'
...
INSTALLED_APPS = [
    ...
    "simple_history",          # for audits
    "staff",                   # your new dashboard app
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'LostandFound', 'templates')],  # Updated path
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
